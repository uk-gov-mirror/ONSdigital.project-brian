...
public class CsdbHandlerTest {
    ...
    public void setUp() throws Exception {
        ...
        route = new CsdbHandler(fileUploadHelper, timeSeriesService, encryptionKeySupplier, dataSetReader);
    ...
    public void shouldReturnTimeSeriesIfHandleSucessful() throws Exception {
        ...
        when(timeSeriesService.convert(uploadFile, dataSetReader, secretKey))
        ...
        verify(timeSeriesService, times(1)).convert(uploadFile, dataSetReader, secretKey);
    }
    ...
    public void shouldPropegateBadRequestExFromFileUploadHelper() throws Exception {
        ...
        try {
            ...
            verify(request, times(1)).raw();
            verify(fileUploadHelper, times(1)).getFileUploadPath(rawRequest, secretKey);
            verifyZeroInteractions(timeSeriesService);
            throw e;
        }
    }
